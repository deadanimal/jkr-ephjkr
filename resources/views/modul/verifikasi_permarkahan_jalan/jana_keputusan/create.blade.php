...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <h5 class="mb-0 text-primary"><strong>Papar Skor Kad</strong></h5>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form action= "/verifikasi_permarkahan_jalan/jana_keputusan/{id}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!--Nama-->
                    <div class="mb-3 row">
