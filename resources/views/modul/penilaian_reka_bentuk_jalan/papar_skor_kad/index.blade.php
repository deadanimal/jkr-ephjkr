...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <h3 class="mb-0 text-primary"><strong>PENILAIAN REKABENTUK JALAN</strong></h3>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col">
          <h4 class="mb-0 text-primary"><strong>Senarai Penilaian Reka Bentuk Yang Sedia Di Jana</strong></h4>
      </div>
  </div>
