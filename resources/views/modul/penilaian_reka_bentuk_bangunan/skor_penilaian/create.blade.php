                ...
                @method('POST')
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td>27</td>
                                <td><input type="number" min="0" max="27"></td>
                                {{-- <td></td>
                                <td></td> --}}
                            </tr> 
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td>3</td>
                                <td><input type="number" min="0" max="3" id="markahKT1_MR_PUN" name="markahKT1_MR_PUN"></td>
                                {{-- <td></td>
                                <td></td> --}}
                                <td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td><input onblur="findTotalMR_KT()" class="MR_KT" type="number" min="0" max="6" id="markahKT52_MR" name="markahKT52_MR" autocapitalize="off" /></td>
                                <td>1</td>
                                <td><input type="number" min="0" max="1"></td>
                                {{-- <td></td>
                                <td></td> --}}
                                <td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td>3</td>
                                {{-- <td><input onblur="findTotalMS_KT()" class="MS_KT" type="number" min="0" max="6" id="markahKT52_MS" name="markahKT52_MS" autocapitalize="off" /></td> --}}
                                <td><input onblur="findTotalMR_KT()" class="MR_KT" type="number" min="0" max="3" id="markahKT52_MR" name="markahKT52_MR" autocapitalize="off" /></td>
                                <td>3</td>
                            ...
                            <tr class="pg-2" align="center">
                             ...
                             <tr class="pg-2" align="center">
                                ...
                                <td>10</td>
                                {{-- <td><input onblur="findTotalMS_KT()" class="MS_KT" type="number" min="0" max="6" id="markahKT52_MS" name="markahKT52_MS" autocapitalize="off" /></td> --}}
                                <td><input onblur="findTotalMR_KT()" class="MR_KT" type="number" min="0" max="10" id="markahKT52_MR" name="markahKT52_MR" autocapitalize="off" /></td>
                                <td>10</td>
                             ...
                             <tr class="pg-2" align="center">
                                ...
                                <td>5</td>
                                {{-- <td><input onblur="findTotalMS_KT()" class="MS_KT" type="number" min="0" max="6" id="markahKT52_MS" name="markahKT52_MS" autocapitalize="off" /></td> --}}
                                <td><input onblur="findTotalMR_KT()" class="MR_KT" type="number" min="0" max="5" id="markahKT52_MR" name="markahKT52_MR" autocapitalize="off" /></td>
                                <td>5</td>
                                <td><input type="number" min="0" max="5"></td>
                                {{-- <td></td>
                                <td></td> --}}
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td>54</td>
                                <td><input id="totalMR_KT" type="number" min="0" max="54" autocapitalize="off" id="markahTOTAL_KT_MR" name="markahTOTAL_KT_MR"/></td>
                                {{-- <td></td>
                                <td></td> --}}
                            </tr> 
                    </table>
                        ...
                        <thead class="text-white">
                            ...
                            <tr class="pg-4" align="center">
                             ...
                             <tr class="pg-4" align="center">
                                ...
                                <td>3</td>
                                {{-- <td><input onblur="findTotalMS_PA()" class="MS_PA" type="number" min="0" max="2" id="markahPA2_MS" name="markahPA2_MS" autocapitalize="off" /></td> --}}
                                <td><input onblur="findTotalMR_PA()" class="MR_PA" type="number" min="0" max="3" id="markahPA2_MR" name="markahPA2_MR" autocapitalize="off" /></td>
                                <td>3</td>
                                <td><input type="number" min="0" max="3"></td>
                                {{-- <td></td>
                                <td></td> --}}
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <th><input  id="totalMR_PA" type="number" min="0" max="22" autocapitalize="off" name="markahTOTAL_PA_MR"/></th>
                                <th>22</th>
                                <th><input type="number" min="0" max="22"></th>
                                {{-- <th>0</th>
                                <th>0</th> --}}
                                <th colspan="5"></th>
                                <th colspan="4"></th>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td>2</td>
                            {{-- <td><input onblur="findTotalMS_PD()" class="MS_PD" id="markahPD24_MS" name="markahPD24_MS" type="number" min="0" max="1" autocapitalize="off" /></td> --}}
                            <td><input onblur="findTotalMR_PD()" class="MR_PD" id="markahPD24_MR" name="markahPD24_MR" type="number" min="0" max="2" autocapitalize="off" /></td>
                            <td>2</td>
                            <td><input type="number" min="0" max="2"></td>
                            {{-- <td></td>
                            <td></td> --}}
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td>3</td>
                            {{-- <td><input onblur="findTotalMS_PD()" class="MS_PD" id="markahPD24_MS" name="markahPD24_MS" type="number" min="0" max="1" autocapitalize="off" /></td> --}}
                            <td><input onblur="findTotalMR_PD()" class="MR_PD" id="markahPD24_MR" name="markahPD24_MR" type="number" min="0" max="3" autocapitalize="off" /></td>
                            <td>3</td>
                            <td><input type="number" min="0" max="3"></td>
                            {{-- <td></td>
                            <td></td> --}}
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>0</td>
                            <td><input type="number" min="0" max="0"></td>
                            {{-- <td></td>
                            <td></td> --}}
                            <td> 
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td><input  id="totalMR_PD" type="number" min="0" max="29" autocapitalize="off" name="markahTOTAL_PD_MR"/></td>
                            <td>27</td>
                            <td><input type="number" min="0" max="27"></td>
                            {{-- <td></td>
                            <td></td> --}}
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td><input  id="totalMR_FL" type="number" min="0" max="5" autocapitalize="off" name="markahTOTAL_FL_MR"/></td>
                                <td>5</td>
                                <td><input  id="totalMR_FL" type="number" min="0" max="5" autocapitalize="off" name="markahTOTAL_FL_MR"/></td>
                                <td></td>
                                <td></td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        ...
                        <tr class="pg-7" align="center">
                            ...
                            <tr class="pg-7" align="center">
                                ...
                                <td colspan="3">6</td>
                                <td><input  id="totalMS_IN" type="number" min="0" max="6" autocapitalize="off" name="markahTOTAL_IN_MS"/></td>
                                <td>6</td>
                                <td>
