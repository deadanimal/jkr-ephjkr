...
@section('content')
    ...
    <div class="row mt-4 mb-3">
        <div class="col">
            <form action="/pengurusan_maklumat/pendaftaran_projek/kemaskini/{{$pp->id}}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row mx-4">
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="namaProjek" type="text" value="{{$pp->namaProjek}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="alamatProjek" type="text" value="{{$pp->alamatProjek}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="poskod" type="number" value="{{$pp->poskod}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="bandar" type="text" value="{{$pp->bandar}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="negeri" type="text" value="{{$pp->negeri}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="keluasanTapak" type="text" value="{{$pp->keluasanTapak}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="jumlahblokBangunan" type="text" value="{{$pp->jumlahblokBangunan}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="statusProjek"  value="Dalam Proses" type="text" value="{{$pp->statusProjek}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="tarikhJangkaMulaPembinaan" type="date" value="{{$pp->tarikhJangkaMulaPembinaan}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="tarikhJangkaSiapPembinaan" type="date" value="{{$pp->tarikhJangkaSiapPembinaan}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="kaedahPelaksanaan" type="text" value="{{$pp->kaedahPelaksanaan}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="jenisPelaksanaan" type="text" value="{{$pp->jenisPelaksanaan}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="kosProjek" type="text" value="{{$pp->kosProjek}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="ahli" type="text" value="{{$pp->ahli}}"/>
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="perananAhli" type="text" value="{{$pp->perananAhli}}"/>
                    </div>
