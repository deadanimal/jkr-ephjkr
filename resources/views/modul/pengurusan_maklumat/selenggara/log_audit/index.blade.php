...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <h3 class="mb-0 text-primary"><strong>SELENGGARA LOG AUDIT</strong></h3>
        </div>
    </div>
                            ...
                            @foreach ($selenggara_status as $ss)
                                <tr>
                                    ...
                                    {{-- <td>
                                        <div class="row">
                                            <div class="col-auto">
                                                <a href="/pengurusan_maklumat/selenggara/selenggara_status/{{ $ss->id }}/edit"
                                                    class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                            </div>
                                            <div class="col-auto">
                                                <form action="/pengurusan_maklumat/selenggara/selenggara_status/{{ $ss->id }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
