...
@section('content')
    ...
    <div class="row mt-4 mb-3">
        <div class="col">
            <form action="/pengurusan_maklumat/selenggara/selenggara_peranan/{{$peranan->id}}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row mx-4">
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="namaa" type="text" value="{{$peranan->name}}"/>
                    </div>
