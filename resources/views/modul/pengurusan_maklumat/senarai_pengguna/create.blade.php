...
@section('content')
    ...
    <div class="row mt-4 mb-3">
        <div class="col">
            <form action="/pengurusan_maklumat/senarai_pengguna" method="post">
                @csrf
                <div class="row mx-4">
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="sijilKompeten" />
                    </div>
                    ...
                    <div class="col-7 mb-2">
                        <input class="form-control" name="kelayakanAkademik" />
                    </div>
