                ...
                {{-- @method('PUT') --}}
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL1_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL2_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL3_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL32_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL4_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL5_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL6_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL81_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL82_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL83_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL84_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td>2</td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL85_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL91_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTL92_MSV}}</td>
                            ...
                            <tr class="pg-1" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTOTAL_TL_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>2</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT1_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>1</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT21_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>1</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT22_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>1</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT31_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>1</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT32_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>5</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT4_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>6</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT52_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>6</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT8_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td>3</td>
                                <td>{{$kriteria_phjkr_bangunan->markahKT11_MSV}}</td>
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td></td>
                                <td></td>
                                <td>{{$kriteria_phjkr_bangunan->markahTOTAL_KT_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                            ...
                            <tr class="pg-3" align="center">
                                ...
                                <td></td>
                                <td>5</td>
                                <td>{{$kriteria_phjkr_bangunan->markahSB1_MSV}}</td>
                            ...
                            <tr class="pg-3" align="center">
                                ...
                                <td></td>
                                <td>5</td>
                                <td>{{$kriteria_phjkr_bangunan->markahSB2_MSV}}</td>
                            ...
                            <tr class="pg-3" align="center">
                                ...
                                <td></td>
                                <td>4</td>
                                <td>{{$kriteria_phjkr_bangunan->markahSB3_MSV}}</td>
                            ...
                            <tr class="pg-3" align="center">
                                ...
                                <td></td>
                                <td>4</td>
                                <td>{{$kriteria_phjkr_bangunan->markahSB4_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td></td>
                                <td>3</td>
                                <td>{{$kriteria_phjkr_bangunan->markahPA1_MSV}}</td>
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td></td>
                                <td>2</td>
                                <td>{{$kriteria_phjkr_bangunan->markahPA2_MSV}}</td>
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td></td>
                                <td>4</td>
                                <td>{{$kriteria_phjkr_bangunan->markahPA3_MSV}}</td>
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td></td>
                                <td>5</td>
                                <td>{{$kriteria_phjkr_bangunan->markahPA32_MSV}}</td>
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td></td>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td>{{$kriteria_phjkr_bangunan->markahTOTAL_PA_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD24_MSV}}</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD24_MMV}}</td>
                            <td></td>
                            <td colspan="2">
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD25_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>2</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD31_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>2</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD32_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD33_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD34_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>3</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD8_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td></td>
                            <td>2</td>
                            <td>{{$kriteria_phjkr_bangunan->markahPD10_MSV}}</td>
                        ...
                        <tr class="pg-5" align="center">
                            ...
                            <td>0</td>
                            <td>0</td>
                            <td>{{$kriteria_phjkr_bangunan->markahTOTAL_PD_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL1_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL1_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL2_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL2_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL21_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL21_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL22_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL22_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL23_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL23_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL3_MSV}}</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL3_MMV}}</td>
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="2"></td>
                                <td></td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL31_MSV}}</td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL32_MSV}}</td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL33_MSV}}</td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td></td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahFL34_MSV}}</td>
                            ...
                            <tr class="pg-6" align="center">
                                ...
                                <td>0</td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahTOTAL_FL_MSV}}</td>
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        ...
                        <tr class="pg-7" align="center">
                            ...
                            <td></td>
                            <td>0</td>
                            <td>{{$kriteria_phjkr_bangunan->markahIN1_MSV}}</td>
                            ...
                            <tr class="pg-7" align="center">
                                ...
                                <td>0</td>
                                <td>0</td>
                                <td>{{$kriteria_phjkr_bangunan->markahTOTAL_IN_MSV}}</td>
