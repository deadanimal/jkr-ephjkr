                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr class="text-black">
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                                <a class="btn btn-primary" href="/verifikasi_permarkahan_bangunan/pengesahan_penilaian/{{$p->id}}" role="button"
                                                data-toggle="tooltip" data-placement="bottom" title="Papar Verifikasi Permarkahan Bangunan">Papar</a>
                                        </td>
                                        </tr> 
                                    @endforeach
                                    </tbody>
