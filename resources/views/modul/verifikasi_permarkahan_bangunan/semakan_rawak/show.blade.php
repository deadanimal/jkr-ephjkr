    ...
    <div class="table-responsive scrollbar">
                ...
                <div class="row mx-3">
                    <table class="table table-bordered line-table shadow-table-jkr">
                        <thead class="text-white line-table">
                                <tr align="center" style="background-color:#EB5500">
                                    <th colspan="3">KEPUTUSAN PENARAFAN HIJAU PERINGKAT VERIFIKASI</th>
                                </tr>

                                <tr align="center" class="text-black">
                                    <th colspan="3">
                                        <a class="button btn btn-primary" href="/verifikasi_permarkahan_bangunan/pengesahan_penilaian/{{$kriteria_phjkr_bangunan->id}}">Semakan Rawak</a>
