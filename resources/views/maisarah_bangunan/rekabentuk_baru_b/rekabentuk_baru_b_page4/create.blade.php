        ...
        <div class="table-responsive scrollbar">
                <form action="/maisarah_bangunan/simpan_skor_baru" method="post" enctype="multipart/form-data">
                     ...
                     <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-4" align="center">
                                ...
                                <td colspan="3">22</td>
                                <td><input  id="totalMR_PA" type="number" min="0" max="22" autocapitalize="off" id="markahTOTAL_PA_MR" name="markahTOTAL_PA_MR" required/></td>
                                <td colspan="9"></td>
                            </tr> 
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/baru_b_page5" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
