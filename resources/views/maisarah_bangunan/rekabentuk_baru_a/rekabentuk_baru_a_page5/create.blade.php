        ...
        <div class="table-responsive scrollbar">
                <form action="/maisarah_bangunan/simpan_skor_baru" method="post" enctype="multipart/form-data">
                    ...
                    @method('POST')
                                        ...
                                        <table id="example" class="table table-bordered line-table display">
                                            ...
                                            <tr class="pg-5" align="center">
                                                ...
                                                <td colspan="6"></td>
                                                <td>0</td>
                                                <td><input onblur="findTotalMR_PD()" class="MR_PD" id="markahPD10_MR" name="markahPD10_MR" type="number" min="0" max="0" autocapitalize="off" required/></td>
                                                <td> 
                                            ...
                                            <tr class="pg-5" align="center">
                                                ...
                                                <td colspan="3">11</td>
                                                <td><input  id="totalMR_PD" type="number" min="0" max="11" autocapitalize="off" id="markahTOTAL_PD_MR" name="markahTOTAL_PD_MR"/></td>
                                                <td colspan="9"></td>
                                            </tr>   
                                        </table>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/baru_a_page6" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
