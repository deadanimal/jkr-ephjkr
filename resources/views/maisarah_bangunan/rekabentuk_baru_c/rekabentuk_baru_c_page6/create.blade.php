                   ...
                   <table id="example" class="table table-bordered line-table display">
                    <thead class="text-white">
                        ...
                        <tr class="pg-6" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>0</td>
                            <td><input onblur="findTotalMR_FL()" class="MR_FL" type="number" min="0" max="0" id="markahFL32_MR" name="markahFL32_MR" required></td>
                            <td>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/baru_c_page7" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
