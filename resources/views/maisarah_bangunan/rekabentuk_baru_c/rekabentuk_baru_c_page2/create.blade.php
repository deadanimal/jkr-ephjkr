        ...
        <div class="table-responsive scrollbar">
                <form action="/maisarah_bangunan/simpan_skor_baru" method="post" enctype="multipart/form-data">
                    ...
                    <table id="example" class="table table-bordered line-table display">
                        <thead class="text-white">
                            ...
                            <tr class="pg-2" align="center">
                                ...
                                <td colspan="3">52</td>
                                <td><input id="totalMR_KT" type="number" min="0" max="52" autocapitalize="off" id="markahTOTAL_KT_MR" name="markahTOTAL_KT_MR"/></td>
                                <td colspan="9"></td>
                            </tr> 
                    </table>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/baru_c_page3" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
