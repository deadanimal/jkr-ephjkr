                  ...
                  <table id="example" class="table table-bordered line-table display">
                    <thead class="text-white">
                        ...
                        <tr class="pg-1" align="center">
                            ...
                            <td colspan="6"></td>                           
                            <td>2</td>
                            <td><input onblur="findTotalMR_TL_PUN()" class="MR_TL_PUN" type="number" min="0" max="2" id="markahTL7_MR_PUN" name="markahTL7_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-1" align="center">
                            ...
                            <td colspan="6"></td>                           
                            <td>2</td>
                            <td><input onblur="findTotalMR_TL_PUN()" class="MR_TL_PUN" type="number" min="0" max="2" id="markahTL82_MR_PUN" name="markahTL82_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-1" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>1</td>
                            <td><input onblur="findTotalMR_TL_PUN()" class="MR_TL_PUN" type="number" min="0" max="1" id="markahTL10_MR_PUN" name="markahTL10_MR_PUN" required></td>
                            <td>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/pun_b_page2" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
