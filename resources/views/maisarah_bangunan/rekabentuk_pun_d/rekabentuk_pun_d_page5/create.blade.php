        ...
        <div class="table-responsive scrollbar">
              ...
              <table id="example" class="table table-bordered line-table display">
                ...
                <tr class="pg-5" align="center">
                    ...
                    <td colspan="6"></td>
                    <td>1</td>
                    <td><input onblur="findTotalMR_PD_PUN()" class="MR_PD_PUN" type="number" min="0" max="1" id="markahPD7_MR_PUN" name="markahPD7_MR_PUN" required></td>
                    <td>
                ...
                <tr class="pg-5" align="center">
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/pun_d_page6" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
