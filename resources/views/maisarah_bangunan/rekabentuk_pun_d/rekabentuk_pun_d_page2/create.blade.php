                ...
                <table id="example" class="table table-bordered line-table display">
                    <thead class="text-white">
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>5</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="5" id="markahKT4_MR_PUN" name="markahKT4_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>1</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="1" id="markahKT53_MR_PUN" name="markahKT53_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>1</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="1" id="markahKT61_MR_PUN" name="markahKT61_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>1</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="1" id="markahKT62_MR_PUN" name="markahKT62_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>3</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="3" id="markahKT7_MR_PUN" name="markahKT7_MR_PUN" required></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                         ...
                         <tr class="pg-2" align="center">
                            ...
                            <td colspan="6"></td>
                            <td>10</td>
                            <td><input onblur="findTotalMR_KT_PUN()" class="MR_KT_PUN" type="number" min="0" max="10" id="markahKT9_MR_PUN" name="markahKT9_MR_PUN" required></td>
                            <td>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/pun_d_page3" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
