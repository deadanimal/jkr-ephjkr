                   ...
                   <table id="example" class="table table-bordered line-table display">
                    <thead class="text-white">
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>2</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="2" autocapitalize="off" id="markahKT1_MMV" name="markahKT1_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="1" autocapitalize="off" id="markahKT21_MMV" name="markahKT21_MMV" required/></td>
                            <td>
                                <span>&#183; Lukisan siap bina</span><br>
                            </td>
                            <td colspan="5"><textarea maxlength="255" rows="5" cols="5" class="form-control" placeholder="Ulasan/Maklumbalas"></textarea></td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="1" autocapitalize="off" id="markahKT22_MMV" name="markahKT22_MMV" required/></td>
                            <td>
                                <span> &#183; Lukisan siap bina</span><br>
                            </td>
                            <td colspan="5"><textarea maxlength="255" rows="5" cols="5" class="form-control" placeholder="Ulasan/Maklumbalas"></textarea></td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="1" autocapitalize="off" id="markahKT31_MMV" name="markahKT31_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>1</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="1" autocapitalize="off" id="markahKT32_MMV" name="markahKT32_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>5</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="5" autocapitalize="off" id="markahKT4_MMV" name="markahKT4_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>6</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="6" autocapitalize="off" id="markahKT52_MMV" name="markahKT52_MMV" required/></td>
                            {{-- <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>6</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="6" autocapitalize="off" id="markahKT8_MMV" name="markahKT8_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>3</td>
                            <td><input onblur="findTotalMMV_KT()" class="MMV_KT" type="number" min="0" max="3" autocapitalize="off" id="markahKT11_MMV" name="markahKT11_MMV" required/></td>
                            <td>
                        ...
                        <tr class="pg-2" align="center">
                            ...
                            <td></td>
                            <td>26</td>
                            <td><input id="totalMMV_KT" type="number" min="0" max="56" id="markahTOTAL_KT_MMV"></td>
                        </tr> 
