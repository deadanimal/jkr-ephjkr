                ...
                <form action="/maisarah_bangunan/simpan_skor_baru" method="post" enctype="multipart/form-data">
                   ...
                   <table id="example" class="table table-bordered line-table display">
                    ...
                    <tr class="pg-5" align="center">
                        ...
                        <td colspan="6"></td>
                        <td>2</td>
                        <td><input onblur="findTotalMR_PD()" class="MR_PD" id="markahPD62_MR" name="markahPD62_MR" type="number" min="0" max="2" autocapitalize="off" required/></td>
                        <td>
                    ...
                    <tr class="pg-5" align="center">
                        ...
                        <td colspan="6"></td>
                        <td>1</td>
                        <td><input onblur="findTotalMR_PD()" class="MR_PD" id="markahPD7_MR" name="markahPD7_MR" type="number" min="0" max="1" autocapitalize="off" required/></td>
                        <td>
                    ...
                    <div class="mb-3 mt-3 text-center">
                        ...
                        <a href="/maisarah_bangunan/baru_d_page6" type="button" class="btn btn-secondary">Seterusnya</a> 
                    </div>
