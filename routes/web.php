...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/penilaian_reka_bentuk_bangunan/pengesahan_penilaian_halaman_2/{id}', [PenilaianRekaBentukBangunanController::class, 'papar_pengesahan_penilaian_halaman_2']);
